...
class UI_Cutwood(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("รายการตัดผ่า")
    ...
    def func_Withdraw_Wood(self):
        ...
        if totem == True:
            ...
            self.neweditInput = withdrawcrad(list_withdraw_cut, self.dateDisplay , self.type_cut)
...
class withdrawcrad (QWidget):
    ...
    def func_insert_to_sql(self,listdata,date):
        ...
        type_withdraw = 1
        woodcode = listdata[0]
        db.func_insert_withdrawcut_tosql(date_withdraw,type_withdraw,woodcode)
